...
public class MessageStatsReport extends Report implements MessageListener {
	...
	public void done() {
		...
		System.out.println(BufferState.countRelay);
		//System.out.println(PointsOfInterest.s1);

		if (this.nrofCreated > 0) {
			deliveryProb = (1.0 * this.nrofDelivered) / this.nrofCreated;
		}
		if (this.nrofDelivered > 0) {
			overHead = 1.0 * (this.nrofRelayed-BufferState.countRelay*2- this.nrofDelivered) /
				this.nrofDelivered;
//			overHead = (1.0 * (this.nrofRelayed-BufferState.countRelay- this.nrofDelivered)) /
//					this.nrofDelivered;
		}
