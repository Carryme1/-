...
public class DTNHost implements Comparable<DTNHost> {
	 ...
	 */
	public synchronized static int getNextAddress() {
		return nextAddress++;
	}
...
//		//if ferry change msg : del in and leave Out
//		if(this.getAddress()==55){
//			Collection<Message> collection = this.getMessageCollection();
//			Iterator<Message> iterator = collection.iterator();
//				while(iterator.hasNext()){
//					Message m = iterator.next();
//					int i = m.getFrom().getAddress();
//					int j = m.getTo().getAddress();
